...
then
    echo "Running unity..."
    /opt/Unity/Editor/Unity -serial ${UNITY_SERIAL} -batchmode -nographics -projectPath /workspace -runTests -testResults /workspace/testResults.xml -logFile /workspace/Editor.log
